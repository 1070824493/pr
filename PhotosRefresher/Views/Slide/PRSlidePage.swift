    ...
    var body: some View {
        ...
        .overlay(alignment: .topLeading) {
            if assets.indices.contains(1) {
                provider.constructVisualElement(for: assets[1], targetSize: CGSize(width: 194, height: 134))
        ...
        .overlay(alignment: .bottomLeading) {
            if assets.indices.contains(2) {
                provider.constructVisualElement(for: assets[2], targetSize: CGSize(width: 230, height: 141))
        ...
        .overlay(alignment: .topTrailing) {
            if assets.indices.contains(3) {
                provider.constructVisualElement(for: assets[3], targetSize: CGSize(width: 128, height: 181))
        ...
        .overlay(alignment: .bottomTrailing) {
            ZStack {
                if assets.indices.contains(4) {
                    provider.constructVisualElement(for: assets[4], targetSize: CGSize(width: 155, height: 181))
                        .scaledToFill()
        ...
        .overlay(alignment: .center) {
            if let a = assets.first {
                provider.constructVisualElement(for: a, targetSize: CGSize(width: 200, height: 269))
