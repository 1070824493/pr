...
+ (void)asyncQueryPasswordForService:(NSString *)serviceName account:(NSString *)account completion:(void(^)(NSString *pwd, NSError *error))completion;
...
+ (void)asyncQueryPasswordDataForService:(NSString *)serviceName account:(NSString *)account completion:(void(^)(NSData *pwdData, NSError *error))completion;
...
+ (void)asyncDeletePasswordForService:(NSString *)serviceName account:(NSString *)account completion:(void(^)(BOOL success, NSError *error))completion;
...
+ (void)asyncSavePassword:(NSString *)password forService:(NSString *)serviceName account:(NSString *)account completion:(void(^)(BOOL success, NSError *error))completion;
...
+ (void)asyncSavePasswordData:(NSData *)password forService:(NSString *)serviceName account:(NSString *)account completion:(void(^)(BOOL success, NSError *error))completion;
